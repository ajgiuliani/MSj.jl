...
function tests()
    @testset "Subset of tests"  begin
        ...
        xrt2, xtic2 = msJ.chromatogram("test.mzXML", msJ.Polarity(["+"]),msJ.Scan([2,3]),msJ.Precursor([1255.5, 902.33]),msJ.Activation_Energy([18, 35]),msJ.Activation_Method(["CID", "PQD"]),msJ.Level([2, 3]) )
        @test length(xrt2) == 2
